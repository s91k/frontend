    ...
    <div className="fixed inset-0 bg-black bg-opacity-80 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-black-2 border border-black-1 rounded-xl shadow-xl p-6 max-w-md w-full mx-4">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-xl font-light text-white">{sector} - {year}</h3>
          <button
            onClick={onClose}
          ...
          <div className="space-y-3">
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm text-white">{scope1.toLocaleString()} tCO₂e</span>
              </div>
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm text-white">{scope2.toLocaleString()} tCO₂e</span>
              </div>
              <div className="h-2 bg-black-1 rounded-full overflow-hidden">
                <div
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm text-white">{scope3.toLocaleString()} tCO₂e</span>
              </div>
              <div className="h-2 bg-black-1 rounded-full overflow-hidden">
                <div
