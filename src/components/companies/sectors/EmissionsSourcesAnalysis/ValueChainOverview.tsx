...
import { Truck, Factory, ShoppingBag, ArrowDown, ChevronRight, ArrowRight } from 'lucide-react';
...
const stages: StageDetails[] = [
  {
    ...
    icon: Truck,
    color: "text-blue-3",
    description: "Supply chain and materials",
    details: [
  ...
  },
  {
    ...
    icon: Factory,
    color: "text-orange-3",
    description: "Direct company activities",
    details: [
...
const ValueChainOverview: React.FC = () => {
  ...
  if (isMobile) {
    return (
      <div className="bg-black-2 border border-black-1 rounded-lg p-4">
        <h3 className="text-base font-light text-white mb-3">Value Chain Overview</h3>
            ...
            return (
              <div key={index} className="relative">
                ...
                >
                  ...
                  <ChevronRight className={`h-4 w-4 text-grey transition-transform ${
  ...
  return (
    <div className="bg-black-2 border border-black-1 rounded-lg p-6">
      <h3 className="text-lg font-light text-white mb-4">Value Chain Overview</h3>
                ...
                <div className="bg-black-1 rounded-lg p-2">
                  <div className="space-y-2">
                    {stage.details.map((detail, i) => (
                      ...
                      >
                        <div className={`w-1 h-1 rounded-full shrink-0 ${stage.color.replace('text-', 'bg-')}`} />
