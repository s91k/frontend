...
function DownloadsPage() {
  ...
  const pageTitle = `${t("downloadsPage.title")} - Klimatkollen`;
  const pageDescription = t("downloadsPage.description");
  const canonicalUrl = `https://klimatkollen.se/${currentLanguage}/data-download/database-download-2024`;
